       ...
       //public Dictionary<string, Task> arbolesPorUsuario = new Dictionary<string, Task>();
        ...
        private void gunaAdvenceButton1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                objusuario.Guardar(nom, apell, pass, usu);
                
                //creamos el objeto arbol para el usuario
                Task arbolnuevo = new Task(null);
                //añadimos el arbol del usuario especificado
                ArbolesUsuarios.Diccionario.Add(usu, arbolnuevo);
               // men.arbolesPorUsuario.Add(nom.ToLower(),arbolnuevo);  
               // Task recibido = arbolesPorUsuario[usu];
            }
        }
